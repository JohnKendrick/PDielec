...
| -threshold z1 z2 | | The modes which are included in the absorption calculation are chosed to have intensities above z1 and have frequencies greater than z2| No
|===
