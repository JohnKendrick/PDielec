...
tab.settings['Mass fraction'] =  0.12076380039021838
...
tab.settings['Bubble radius'] =  30.0
tab.settings['Bubble volume fraction'] =  0.0
tab.settings['Mass fraction'] =  0.12076380039021842
tab.settings['Volume fraction'] =  0.10000000000000002
tab.settings['Particle size(mu)'] =  0.0001
tab.settings['Particle size distribution sigma(mu)'] =  0.0
tab.settings['Ellipsoid a/b'] =  0.5
tab.settings['Unique direction - h'] =  2
...
tab.settings['Bubble radius'] =  30.0
tab.settings['Bubble volume fraction'] =  0.0
tab.settings['Mass fraction'] =  0.12076380039021845
...
tab.settings['Minimum frequency'] =  500
tab.settings['Maximum frequency'] =  1600
...
tab.settings['concentration'] =  13.585502808755502
tab.settings['cell concentration'] =  13.585502808755502
