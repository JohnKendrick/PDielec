...
tab.settings['Output file name'] = 'raman.abo'
...
tab.settings['Mass fraction'] =  0.23234829945128524
tab.settings['Volume fraction'] =  0.09999999999999998
...
tab.settings['ATR S polarisation fraction'] =  0.5
tab.settings['Raman laser frequency'] =  785
tab.settings['Raman laser polarisation'] = 'VH'
tab.settings['Raman temperature'] =  298.0
tab.settings['Raman orientation samples'] =  512
tab.settings['Raman electro-optic term'] =  False
#
...
tab.settings['Legend'] = 'Unpolarised'
tab.settings['Scenario type'] = 'Unset'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Matrix'] = 'ptfe'
tab.settings['Matrix density'] =  2.2
...
tab.settings['ATR S polarisation fraction'] =  0.5
tab.settings['Raman laser frequency'] =  785
tab.settings['Raman laser polarisation'] = 'Unpolarised'
tab.settings['Raman temperature'] =  298.0
tab.settings['Raman orientation samples'] =  512
tab.settings['Raman electro-optic term'] =  False
#
...
tab.settings['Legend'] = 'Unpolarised +EO'
tab.settings['Scenario type'] = 'Unset'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Matrix'] = 'ptfe'
tab.settings['Matrix density'] =  2.2
...
tab.settings['Scenarios to plot'] =  [True, True, True, True]
tab.settings['concentration'] =  36.82103509162935
tab.settings['cell concentration'] =  36.82103509162935
