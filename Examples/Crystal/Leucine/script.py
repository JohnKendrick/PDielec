...
tab.settings['Output file name'] = 'LEUCINE_FREQUENCY_PBED3_631Gdp_FULLOPTIMIZATON.out'
#
# SettingsTab
#
...
tab.settings['Optical permittivity'] = [ [2.3471, 0.0, 0.0786], [0.0, 2.3942, 0.0], [0.0786, 0.0, 2.2621] ]
#
# 0th Scenario tabs
#
...
tab.settings['Plot title'] = 'Crystal14 - Leucine'
#
# Analysis Tab
#
