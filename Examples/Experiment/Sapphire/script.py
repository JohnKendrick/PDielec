...
tab.settings['Excel file name'] = 'reflectance-r-planes.xlsx'
...
tab.settings['Legend'] = 'Sapphire r-plane 45deg Thick Slab'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = 'TestDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  45.0
...
tab.settings['Layer hkls'] =  [[0, 0, 1], [1, -1, 2]]
tab.settings['Layer azimuthals'] =  [0.0, 90.0]
...
tab.settings['Layer hkls'] =  [[0, 0, 1], [1, -1, 2]]
tab.settings['Layer azimuthals'] =  [0.0, 90.0]
tab.settings['Layer thicknesses'] =  [1.0, 2.0]
tab.settings['Layer thickness units'] =  ['nm', 'um']
tab.settings['Layer dielectric flags'] =  [True, False]
#
#
...
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['Dielectric film', 'Sapphire-Lee', 'Silicon']
tab.settings['Layer hkls'] =  [[0, 0, 1], [1, -1, 2], [0, 0, 0]]
tab.settings['Layer azimuthals'] =  [0.0, 90.0, 0.0]
tab.settings['Layer thicknesses'] =  [1.0, 2.0, 1.0]
tab.settings['Layer thickness units'] =  ['nm', 'um', 'um']
tab.settings['Layer dielectric flags'] =  [True, False, False]
#
#
self.notebook.addScenario(scenarioType="Single crystal")
...
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['Dielectric film', 'Sapphire-Lee', '6H-SiC']
tab.settings['Layer hkls'] =  [[0, 0, 1], [1, -1, 2], [0, 0, 1]]
tab.settings['Layer azimuthals'] =  [0.0, 90.0, 0.0]
tab.settings['Layer thicknesses'] =  [1.0, 2.0, 1.0]
tab.settings['Layer thickness units'] =  ['nm', 'um', 'um']
tab.settings['Layer dielectric flags'] =  [True, False, False]
