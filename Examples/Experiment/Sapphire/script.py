...
tab.settings['Layer hkls'] =  [[0, 0, 0], [1, -1, 2]]
...
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['air', 'Sapphire-Lee', 'air']
tab.settings['Layer hkls'] =  [[0, 0, 0], [1, -1, 2], [0, 0, 0]]
tab.settings['Layer azimuthals'] =  [0, 90.0, 0.0]
tab.settings['Layer thicknesses'] =  [1, 2.0, 1.0]
tab.settings['Layer thickness units'] =  ['um', 'um', 'um']
tab.settings['Layer incoherent options'] =  ['Coherent', 'Coherent', 'Coherent']
tab.settings['Layer dielectric flags'] =  [False, False, False]
tab.settings['Slice thickness'] =  0
tab.settings['Slice thickness unit'] = 'um'
#
#
...
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['air', 'Sapphire-Lee', 'Silicon']
tab.settings['Layer hkls'] =  [[0, 0, 0], [1, -1, 2], [0, 0, 0]]
tab.settings['Layer azimuthals'] =  [0, 90.0, 0.0]
tab.settings['Layer thicknesses'] =  [1, 2.0, 1.0]
tab.settings['Layer thickness units'] =  ['um', 'um', 'um']
...
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['air', 'Sapphire-Lee', '6H-SiC']
tab.settings['Layer hkls'] =  [[0, 0, 0], [1, -1, 2], [0, 0, 1]]
tab.settings['Layer azimuthals'] =  [0, 90.0, 0.0]
tab.settings['Layer thicknesses'] =  [1, 2.0, 1.0]
tab.settings['Layer thickness units'] =  ['um', 'um', 'um']
tab.settings['Layer incoherent options'] =  ['Coherent', 'Coherent', 'Coherent']
