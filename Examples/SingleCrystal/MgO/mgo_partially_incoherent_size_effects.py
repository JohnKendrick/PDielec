...
tab.settings['Excel file name'] = 'mgo_partially_incoherent_size_effects.xlsx'
tab.settings['Script file name'] = 'mgo_partially_incoherent_size_effects.py'
...
tab.settings['Layer thicknesses'] =  [1, 10.0]
tab.settings['Layer thickness units'] =  ['um', 'nm']
...
tab.settings['Legend'] = 'Partially incoherent 0.1um'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  45.0
tab.settings['Mode'] = 'Transfer matrix'
tab.settings['Frequency units'] = 'wavenumber'
tab.settings['Partially incoherent samples'] =  10
tab.settings['Percentage partial incoherence'] =  20
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
...
tab.settings['Legend'] = 'Partially incoherent 1um'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  45.0
...
tab.settings['Legend'] = 'Partially incoherent 10um'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  45.0
tab.settings['Mode'] = 'Transfer matrix'
tab.settings['Frequency units'] = 'wavenumber'
tab.settings['Partially incoherent samples'] =  1000
tab.settings['Percentage partial incoherence'] =  60
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['air', 'Dielectric layer', 'air']
tab.settings['Layer hkls'] =  [[0, 0, 0], [0, 0, 1], [0, 0, 0]]
...
tab.settings['Legend'] = 'Partially incoherent 100um'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  45.0
...
tab.settings['Frequency units'] = 'wavenumber'
tab.settings['Partially incoherent samples'] =  1000
tab.settings['Percentage partial incoherence'] =  30
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['air', 'Dielectric layer', 'air']
tab.settings['Layer hkls'] =  [[0, 0, 0], [0, 0, 1], [0, 0, 0]]
...
tab.settings['Frequency increment'] =  0.1999999999975
