...
tab.settings['Excel file name'] = 'mgo_incoherent_size_effects.xlsx'
tab.settings['Script file name'] = 'mgo_incoherent_size_effects.py'
...
tab.settings['Legend'] = '0.01 mm Incoherent (intensity)'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  45.0
...
tab.settings['Layer thicknesses'] =  [1, 0.01, 1.0]
tab.settings['Layer thickness units'] =  ['um', 'mm', 'um']
...
tab.settings['Legend'] = '0.10 mm Incoherent (intensity)'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  45.0
...
tab.settings['Legend'] = '1.00 mm Incoherent (intensity)'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '../../../PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  45.0
...
tab.settings['Maximum frequency'] =  1600.0
tab.settings['Frequency increment'] =  0.30001875117007315
