...
tab.settings['Excel file name'] = 'mgo_comparison_of_incoherent_methods.xlsx'
tab.settings['Script file name'] = 'mgo_comparison_of_incoherent_methods.py'
...
tab.settings['Frequency increment'] =  0.19999999999875
