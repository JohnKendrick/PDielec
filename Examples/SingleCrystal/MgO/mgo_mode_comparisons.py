...
tab.settings['Excel file name'] = 'mgo_mode_comparisons.xlsx'
tab.settings['Script file name'] = 'mgo_mode_comparisons.py'
...
tab.settings['Legend'] = 'Incoherent'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Unique direction - h'] =  0
tab.settings['Unique direction - k'] =  0
tab.settings['Unique direction - l'] =  1
...
tab.settings['Legend'] = 'Partially incoherent'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Unique direction - h'] =  0
tab.settings['Unique direction - k'] =  0
tab.settings['Unique direction - l'] =  1
...
tab.settings['Frequency units'] = 'wavenumber'
tab.settings['Partially incoherent samples'] =  100
tab.settings['Percentage partial incoherence'] =  10
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
#
#
