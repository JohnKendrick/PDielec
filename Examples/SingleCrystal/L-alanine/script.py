...
tab.settings['Layer hkls'] =  []
tab.settings['Layer azimuthals'] =  []
tab.settings['Layer thicknesses'] =  []
tab.settings['Layer thickness units'] =  []
tab.settings['Layer dielectric flags'] =  []
...
tab.settings['Filter kernel size'] =  1
tab.settings['Filter polynomial size'] =  3
tab.settings['Layer material names'] =  ['Dielectric film']
tab.settings['Layer hkls'] =  [[0, 0, 1]]
tab.settings['Layer azimuthals'] =  [0.0]
tab.settings['Layer thicknesses'] =  [0.05]
tab.settings['Layer thickness units'] =  ['mm']
...
tab.settings['Legend'] = 'a-axis field for S-polarisation (incoherent)'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '/home/john/Software/PDielec/PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  0.0
...
tab.settings['Layer material names'] =  ['Dielectric film']
tab.settings['Layer hkls'] =  [[0, 0, 1]]
tab.settings['Layer azimuthals'] =  [90.0]
tab.settings['Layer thicknesses'] =  [0.05]
tab.settings['Layer thickness units'] =  ['mm']
tab.settings['Layer dielectric flags'] =  [True]
tab.settings['Superstrate dielectric'] =  1.0
...
tab.settings['Legend'] = 'b-axis field for S-polarisation (incoherent)'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '/home/john/Software/PDielec/PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  0.0
...
tab.settings['Legend'] = 'c-axis field for S polarisation (incoherent)'
tab.settings['Scenario type'] = 'Single crystal'
tab.settings['Materials database'] = '/home/john/Software/PDielec/PDielec/MaterialsDataBase.xlsx'
tab.settings['Global azimuthal angle'] =  0.0
tab.settings['Angle of incidence'] =  0.0
