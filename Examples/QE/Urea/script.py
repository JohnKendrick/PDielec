...
tab.settings['Phonopy QM program'] = ''
tab.settings['Output file name'] = 'urea.ir.dynG'
...
tab.settings['Materials database'] = '../../../../../Software/PDielec/PDielec/MaterialsDataBase.xlsx'
...
tab.settings['Mass fraction'] =  0.06554183101589822
...
tab.settings['concentration'] =  11.562263113176545
tab.settings['cell concentration'] =  11.562263113176545
