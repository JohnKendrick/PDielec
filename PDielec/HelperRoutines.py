...
def getMaterial(
    name,
    dataBaseName="MaterialsDataBase.xlsx",
    qmprogram="vasp",
    eckart=True,
...
def calculateSingleCrystalSpectrum(
    frequencies_cm1,
    layers,
    incident_angle,
    ...
    for v_cm1 in frequencies_cm1:
        (v, r, R, t, T, epsilon, errors, largest_exponent) = (
...
def calculatePowderSpectrum(
    ...
    for v_cm1 in frequencies_cm1:
        ...
        result = Calculator.solve_effective_medium_equations(
            method,
            volume_fraction,
            particle_size_mu,
            particle_sigma_mu,
