...
class CrystalRamanScenarioTab(ScenarioTab):
    ...
    specific to handling Crystal Raman scenarios, including setting up the scenario environment, defining the crystal
    ...
    A string representing the type of scenario. For this class, it is set to 'Crystal Raman'. refresh_required : bool
    ...
    and initializing the user interface components relevant to the Crystal Raman scenario.
