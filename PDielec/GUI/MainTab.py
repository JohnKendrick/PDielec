...
class MainTab(QWidget):
    ...
    def on_file_button_clicked(self):
        ...
        `Abinit`, `Gulp`, `Vasp`, `Quantum Espresso`, `Crystal`, `Phonopy`, `Experiment`, `Pdgui`, or any file
        type). Based on the selected file, it finds the corresponding program that generated the file, updates
        ...
        if self.settings["Program"].lower() == "castep":
            ...
            selfilter = "All files (*)"
        filename,myfilter = compat.getopenfilename(self,"Open MM/QM Output file","","Abinit (*.out *.abo);;Aims (*.dat *.in);;Castep (*.castep);;Crystal (*.out  *.log);;Experiment (*.exp);;Gulp (*.gout);;Phonopy (*.yaml);;Quantum Espresso (*.dynG);;Vasp (OUTCAR*);;PDGui (*.py);;All files(*)",selfilter)
