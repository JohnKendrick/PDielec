...
class SpreadSheetManager():
    def __init__(self, filename):
        ...
        self.tab_names = ['Main', 'Settings', 'Scenarios', 'Molar Absorption','Absorption', 'Real Permittivity', 'Imaginary Permittivity', 'ATR Reflectance','Analysis','Single Crystal','Crystal Molar Absorption','Crystal Absorption','Crystal Reflectance']
        self.worksheets = {}
