...
class PlottingTab(QWidget):
    ...
    def writeSpreadsheet(self):
        ...
        if self.notebook.spreadsheet is None:
            self.debugger.print("Finished::writeSpreadsheet spreadsheet is None")
            return
