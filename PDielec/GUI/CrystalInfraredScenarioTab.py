...
class CrystalInfraredScenarioTab(ScenarioTab):
    ...
    def __init__(self, parent, debug=False ):
        ...
        self.debugger = Debug(debug,"CrystalInfraredScenarioTab:")
    ...
    def coherent_calculator( self,
        ...
        results = []
        # About to call
        self.debugger.print(self.settings["Legend"],"About to calculate crystal infrared scenario using pool")
        ...
        s_absorbtance = []
        epsilon = []
        self.debugger.print(self.settings["Legend"],"About to extract results for crystal infrared scenario")
