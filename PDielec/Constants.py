...
isotopic_masses is a dictionary of masses for each element, the key is an element name.  The contents is a list of
tuples, each tuple contains, three numbers: the first is the isotope, the second is its mass and the last is its
percentage occurence on average.

covalent_radii is a dictionary of covalent radii taken from: Beatriz Cordero, Veronica Gomex, Ana E. Platero-Prats, Marc
Reves, Jorge Echeverria, Eduard Cremades, Flavia Barragan and Santiago Alvarez (2008) Covalent Radii Revisited - Dalton
Trans. (21) 2832-2838 doi:10.1039/b801115j
